  ...
  useAsyncEffect(
    async (isMounted) => {
      ...
      while (true) {
        ...
        setRanks({
          [KeyType.STRING]: Array.from(
            heaps[KeyType.STRING].toArray() as Data[],
          ),
          [KeyType.LIST]: Array.from(heaps[KeyType.LIST].toArray() as Data[]),
          [KeyType.SET]: Array.from(heaps[KeyType.SET].toArray() as Data[]),
          [KeyType.HASH]: Array.from(heaps[KeyType.HASH].toArray() as Data[]),
          [KeyType.ZSET]: Array.from(heaps[KeyType.ZSET].toArray() as Data[]),
        })
